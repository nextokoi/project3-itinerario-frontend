  ...
  return (
    <Box sx={{ px: 10, my: 5}}>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: '10px', mb: 5 }}>
            <ActivityCard cardImg={'./../../../../../public/photos/onsen.jpg'} cardText={'Onsen'}/>
            <ActivityCard cardImg={'./../../../../../public/photos/shrine.jpg'} cardText={'Hakone Shrine'}/>
        </Box>
        <Box sx={{mb: 5}}>
            <Box sx={{mb: 2}}>
                <Typography variant="h6">Day 1</Typography>
                <ActivitySelectedCard cardImg={'./../../../../../public/photos/onsen.jpg'} cardTitle={'Tenzan Tohji-kyo'} cardSubtitle={'Yumoto, Hakone'}/>
            </Box>
            <Box>
                <Typography variant="h6">Day 2</Typography>
                <ActivitySelectedCard cardImg={'./../../../../../public/photos/shrine.jpg'} cardTitle={'Hakone Shrine'} cardSubtitle={'Jinja, Hakone'}/>
            </Box>
        </Box>
